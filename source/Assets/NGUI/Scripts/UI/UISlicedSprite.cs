...
{
	//public float TopLeftCornerMult = 1f; // added by Eyal for additional control
	//public float BottomRightCornerMult = 1f;  // added by Eyal for additional control
	...
	public float mCornerMult = 1f;
	public int mAtlasSize = 1024;
	...
	public float cornerMult { 
		get { return mCornerMult;}
		set {
			mCornerMult = value;
			mAtlasSize = atlas.texture.width;
			MarkAsChanged();
			//Debug.Log ("Atlas size is " + mAtlasSize);
		} 
	}
	//public int atlasSize { get { return mAtlasSize;} set {mAtlasSize = value; MarkAsChanged();  } }
...
#endif
	{
		...
		if (tex != null)
		{
			...
			Vector2 tl = new Vector2(borderLeft / sz.x, borderTop / sz.y) * mCornerMult * mAtlasSize / atlas.texture.width;
			Vector2 br = new Vector2(borderRight / sz.x, borderBottom / sz.y) * mCornerMult * mAtlasSize / atlas.texture.width;
