...
public class BetterList<T>
{
	...
	void Trim ()
	{//Gavin Dodd - removed Trim.
		//this causes to many reallocations triggering garbage collection
		//TROz GUI was taking an additional 30-40ms every 10s or so due to this.
		/*if (size > 0)
		{
		...
		//TODO: add some kind of assert if buffer.Length is much larger than size?
	...
	//Trim causes to many reallocations triggering garbage collection
	//TROz GUI was taking an additional 30-40ms every 10s or so due to this.
	//If Release is ever used the same problem could re-occur
