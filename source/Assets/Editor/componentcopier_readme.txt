Component Copier
an editor extension tool for Unity 3D
...
The Component Copier tries to show you the most relevant variables by showing you only variables that are declared in the component's class. Sometimes you want a variable that the component inherited from a parent class. You can make these variables show up in Component Copier by changing "BindingFlags.DeclaredOnly" to "BindingFlags.Default" at the end of (currently) lines 47 and 48 of the script. Just be warned that you will probably get a lot of inherited variables you aren't interested in as well.
