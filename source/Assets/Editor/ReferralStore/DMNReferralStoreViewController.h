 ...
 */
@interface DMNReferralStoreViewController : UIViewController<UIWebViewDelegate, DMNReferralStoreConnectionDelegate> {
   UIWebView*                  _webview;
   UIButton*                   _closeButton;
   UIActivityIndicatorView*    _activityIndicator;
   
   DMNReferralStoreConnectionManager *_connectionManager;
}
