...
- (void)askForReviewWithLaunchCountLocalized:(int)launchCount hoursBetweenPrompts:(int)hoursBetweenPrompts title:(NSString*)title message:(NSString*)message iTunesUrl:(NSString*)iTunesUrl remindMeLater:(NSString*)remindMeLater
    yesRateIt:(NSString*)yesRateIt dontAskAgain:(NSString*)dontAskAgain;
