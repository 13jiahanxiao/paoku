...
void _etceteraAskForReviewLocalized( int launchCount, int hoursBetweenPrompts, const char * title, const char * message, const char * iTunesUrl, const char * remindMeLater, const char * yesRateIt, const char * dontAskAgain )
{
	[[EtceteraManager sharedManager] askForReviewWithLaunchCountLocalized:launchCount
											 hoursBetweenPrompts:hoursBetweenPrompts
														   title:GetStringParam( title )
														 message:GetStringParam( message )
													   iTunesUrl:GetStringParam( iTunesUrl )
                                                   remindMeLater:GetStringParam( remindMeLater)
                                                       yesRateIt:GetStringParam( yesRateIt)
                                                    dontAskAgain:GetStringParam( dontAskAgain)];
}
