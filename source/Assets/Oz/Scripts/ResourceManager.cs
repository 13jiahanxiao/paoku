...
public class ResourceManager : MonoBehaviour
{
	...
	/// <summary>
	/// Gets the version string, major dot minor format
	/// </summary>
	/// <returns>
	/// The version string. e.g "1.21"
	/// </returns>
	public static string GetVersionString() 
	{
		...
		try
		{
			TextAsset versionAsset = (TextAsset) Resources.Load ("version", typeof(TextAsset));
			
			result = versionAsset.text.Trim();
		}
		catch ( System.Exception e)
		{
			notify.Error("Error reading version.txt Exception =" + e.Message);
		}
		return result;
	}
	...
	{
		string clientVersion = GetVersionString();
