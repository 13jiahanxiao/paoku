...
//			Debug.Log("Should Turn Right");
	...
	public void ShootArrow(Vector2 screenPosition)
	{
		...
		float touchSide = Mathf.Floor((screenPosition.x / (GameCamera.SharedInstance.camera.GetScreenWidth() / 2f))) - 1f; // -1 is left, 1 is supposed to be right but it's actually 0
