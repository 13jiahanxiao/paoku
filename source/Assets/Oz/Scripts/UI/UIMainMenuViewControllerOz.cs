...
{	
	...
	public override void appear()
	{
		...
		UIManagerOz.SharedInstance.PaperVC.SetBurstlyButton(false);
	...
	public override void disappear()
	{
		...
		UIManagerOz.SharedInstance.PaperVC.SetBurstlyButton(true);
...
//	private List<UISlicedSprite> buttonBGs = new List<UISlicedSprite>();
...
//			buttonBGs.Add(buttonGO.transform.Find("Background").GetComponent<UISlicedSprite>());
