...
public class PauseObjectives : MonoBehaviour 
{
	...
	public void FillInObjectiveData() 
	{
		...
		if (GameProfile.SharedInstance.Player.objectivesActive.Count>=3 &&
			GameProfile.SharedInstance.Player.objectivesActive[0]==null &&
			GameProfile.SharedInstance.Player.objectivesActive[1]==null &&
			GameProfile.SharedInstance.Player.objectivesActive[2]==null)
		{
