...
public class CellBoundsChecker : MonoBehaviour 
{
	...
	void Start()
	{
		background = transform.Find("CellContents/GraphicsAnchor/SlicedSprite (bg_storecell)").GetComponent<UISlicedSprite>();
		...
		//dragPanel = transform.parent.parent.GetComponent<UIDraggablePanel>();
