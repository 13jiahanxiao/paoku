...
//		iTween.MoveTo(tabGO.transform.Find("Checkmark").gameObject, iTween.Hash(
//			"position", targetTabSettings.backgroundPosition,
//			"islocal", true,
//			"time", tweenTime,
//			"easetype", iTween.EaseType.easeInOutSine));		
//		
//		tabGO.transform.Find("Checkmark").gameObject.GetComponent<UISprite>().enabled = bigger;		
//		
//		iTween.MoveTo(tabGO.transform.Find("Background").gameObject, iTween.Hash(
//			"position", targetTabSettings.backgroundPosition,
//			"islocal", true,
//			"time", tweenTime,
//			"easetype", iTween.EaseType.easeInOutSine));				
//
//		iTween.MoveTo(tabGO.transform.Find("Frame").gameObject, iTween.Hash(
//			"position", targetTabSettings.framePosition,
//			"islocal", true,
//			"time", tweenTime,
//			"easetype", iTween.EaseType.easeInOutSine));

//		backgroundPosition = new Vector3 (0.0f, tabGO.transform.Find("Background").localPosition.y, tabGO.transform.Find("Background").localPosition.z);
//		framePosition = new Vector3 (0.0f, tabGO.transform.Find("Frame").localPosition.y, tabGO.transform.Find("Frame").localPosition.z);


		//tabGO.transform.Find("Frame").transform.GetComponent<UISprite>().depth = targetTabSettings.frameDepth;


	//public int frameDepth;	

		//frameDepth = tabGO.transform.Find("Frame").transform.GetComponent<UISprite>().depth;
	...
	//public Vector3 spritePosition;	
		...
		//spritePosition = new Vector3 (0.0f, tabGO.transform.Find("Sprite").localPosition.y, tabGO.transform.Find("Sprite").localPosition.z);	

		
//		iTween.MoveTo(tabGO.transform.Find("Sprite").gameObject, iTween.Hash(
//			"position", targetTabSettings.spritePosition,
//			"islocal", true,
//			"time", tweenTime,
//			"easetype", iTween.EaseType.easeInOutSine));